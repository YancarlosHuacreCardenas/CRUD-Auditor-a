...
public class CustomerServiceImpl implements CustomerService {
    ...
    public Customer update(Long id, Customer customer) {
        ...
        existing.setCellPhone(customer.getCellPhone());
        existing.setFirstName(customer.getFirstName());
        existing.setLastName(customer.getLastName());
        existing.setState("A");
        existing.setUpdatedAt(LocalDateTime.now());  // Establecer la fecha de actualización
    ...
    public Customer restore(Long id) {
        ...
        customer.setDeletedAt(null);               // Limpiar la marca de eliminación cuando se restaura
        return customerRepository.save(customer);
    }
